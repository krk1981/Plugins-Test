...
## Skill: deal-workspace
---
name: deal-workspace
description: Set up a complete deal workspace for any prospect — gather email context, research the account, build a sales plan and project plan, then publish everything to Confluence. Works for new business, expansions, RFP responses, and renewals. Trigger with "deal workspace for [Company]", "set up a deal for [Company]", "work on [Company] proposal", or "/deal-workspace [Company]".
---

# Deal Workspace

Build a complete, structured deal workspace for any prospect or proposal. Gathers context from emails, researches the account, generates a sales plan and project plan, and publishes to Confluence — all in one workflow.
...
Invoke this skill when:
- User says `/deal-workspace` or `/deal-workspace [CompanyName]`
- User asks to "set up a deal workspace", "create a deal plan", "work on proposal for X"
- User wants to pull email context into a structured deal plan
- User wants to create or update Confluence pages for a deal
- User mentions needing both a sales plan and project plan for a prospect
...
├─────────────────────────────────────────────────────────────────┤
│  ALWAYS (works standalone)                                       │
│  ✓ Gather deal context from Gmail emails                        │
│  ✓ Research the prospect (web search + account intel)           │
│  ✓ Generate sales plan (MEDDPICC, strategy, stakeholders)       │
│  ✓ Generate project plan (scope, milestones, deliverables)      │
│  ✓ Save all artifacts locally                                   │
├─────────────────────────────────────────────────────────────────┤
│  SUPERCHARGED (when Confluence is connected)                     │
│  + Create Confluence space/page for the deal                    │
│  + Publish sales plan and project plan as structured pages      │
│  + Organize under a consistent page hierarchy                   │
│  + Update existing pages on re-runs                             │
├─────────────────────────────────────────────────────────────────┤
│  BONUS (when CRM / enrichment connected)                         │
│  + Pull deal history and prior opportunities from CRM           │
│  + Enrich contacts with verified emails, phone, org chart       │
│  + Pull activity timeline for engagement context                │
└─────────────────────────────────────────────────────────────────┘
```

---

## Phase 0: Collect Deal Context

### Step 0.1: Identify the Deal

Ask the user (or parse from their message):

| Field | Prompt | Required |
|-------|--------|----------|
| **Company name** | "Which company is this deal for?" | Yes |
| **Deal type** | "What type of deal?" | Yes |
| **Email search terms** | "Any specific email subjects or keywords to search?" | No |
| **Confluence space** | "Which Confluence space? (leave blank to auto-create)" | No |

**Deal type options:**
- New Business — first engagement with this prospect
- Expansion — existing customer, new product/scope
- Renewal — contract renewal or extension
- RFP Response — responding to a formal request for proposal
- Partnership — strategic partnership or integration

### Step 0.2: Search Gmail for Deal Context

Use the Gmail MCP server to find relevant emails:

```
Search strategy (run multiple searches):
1. Search: "[Company Name]" — all emails mentioning the company
2. Search: "[Company Name] proposal" — proposal-specific threads
3. Search: "[Company Name] meeting" — meeting-related threads
4. Search: "[Key Contact Name]" — if contact names are known
```

**For each relevant email thread, extract:**
- Subject and participants
- Deal context: what's being discussed, what stage
- Requirements or pain points mentioned
- Timeline references (deadlines, go-live dates)
- Budget signals (amounts, budget cycles, approvals)
- Decision makers mentioned
- Attachments referenced (note their existence)
- Action items or next steps discussed
- Competitor mentions

**Compile into a Deal Context Brief:**

```yaml
deal_context:
  company: "[Company Name]"
  deal_type: "[New Business / Expansion / Renewal / RFP / Partnership]"
  email_threads_analyzed: [count]
  key_contacts:
    - name: "[Name]"
      role: "[Title]"
  ...
  open_questions:
    - "[Things still unclear from emails]"
```

### Step 0.3: Ask Clarifying Questions

After email analysis, ask the user to fill gaps:

```
"I've reviewed [X] email threads about [Company]. Here's what I found:
[Brief summary of deal context]

A few questions to complete the picture:
1. [Question about unclear requirement]
2. [Question about timeline if not found]
3. [Question about decision process]
4. Any additional context I should know?"
```

**Max 1 round of questions.** If still ambiguous, proceed with best understanding and note assumptions.

---

## Phase 1: Account & Market Research

### Step 1.1: Company Research

Run web searches to build a complete account profile:

```
Searches:
1. "[Company Name]" — homepage, about page
2. "[Company Name] news 2025 2026" — recent developments
3. "[Company Name] [industry] market" — industry positioning
4. "[Company Name] leadership CEO CTO" — key executives
5. "[Company Name] technology platform" — tech landscape
```

**Extract:**
- Company overview (what they do, size, industry, HQ)
- Recent news and strategic priorities
- Leadership team
- Technology landscape
- Market position and competitors

### Step 1.2: Industry Context (for Project Plan)

```
Searches:
1. "[Industry] digital transformation trends 2026"
2. "[Industry] [deal topic] best practices"
3. "[Industry] technology adoption challenges"
```

**Extract:**
- Industry trends relevant to the deal
- Common challenges and success patterns
- Benchmarks and metrics

---

## Phase 2: Sales Plan Generation

Generate a structured sales plan using the MEDDPICC framework.

### Sales Plan Template

```markdown
# Sales Plan: [Company Name]
## [Deal Type] — [One-line deal summary]

**Generated:** [Date]
**Deal Owner:** [User's name if known]
**Sources:** Gmail ([X] threads), Web Research, [CRM if connected]

---

## Executive Summary

[2-3 sentences: What is this deal, why does it matter, what's the path to close]
...
### Metrics
- **Business impact:** [Quantified value the prospect expects]
- **Key KPIs:** [Metrics they care about]
- **ROI indicators:** [How they'll measure success]

### Economic Buyer
- **Name:** [Name]
- **Title:** [Title]
- **Engagement level:** [Identified / Engaged / Champion / Unknown]
- **Notes:** [What we know about their priorities]

### Decision Criteria
- **Technical:** [Technical requirements from emails/conversations]
- **Business:** [Business requirements]
- **Compliance:** [Any regulatory or compliance needs]

### Decision Process
- **Steps:** [Known approval process]
- **Timeline:** [Expected decision date]
- **Stakeholders involved:** [List of people in the process]

### Identify Pain
- [Pain point 1 — evidence from emails]
- [Pain point 2 — evidence from research]
- [Pain point 3 — inferred from industry]

### Champion
- **Name:** [Internal champion if identified]
- **Relationship strength:** [Strong / Building / Unknown]
- **What they need from us:** [How to enable them]

### Paper Process
- **Contract type:** [Standard / Custom / RFP response]
- **Legal review needed:** [Yes / No / Unknown]
- **Procurement involved:** [Yes / No / Unknown]
- **Estimated timeline:** [Weeks/months from decision to signature]

### Competition
- **Known competitors:** [From emails and research]
- **Our positioning:** [Why we win against each]
...
| Name | Title | Role in Deal | Sentiment | Engagement | Next Action |
|------|-------|--------------|-----------|------------|-------------|
| [Name] | [Title] | [Champion/Evaluator/Decision Maker/Blocker] | [Positive/Neutral/Negative] | [High/Medium/Low] | [Action] |
...
### Positioning
[How we position our solution for this specific prospect and their needs]

### Win Themes
1. **[Theme 1]:** [Why this resonates with this prospect]
2. **[Theme 2]:** [Supporting evidence]
3. **[Theme 3]:** [Differentiator]

### Risk Factors
| Risk | Likelihood | Impact | Mitigation |
|------|-----------|--------|------------|
| [Risk 1] | [H/M/L] | [H/M/L] | [Action to mitigate] |
| [Risk 2] | [H/M/L] | [H/M/L] | [Action to mitigate] |
...
|------|-----------|--------|
| [Date] | [Milestone from emails or strategy] | [Done/Upcoming/At Risk] |
```
...
Generate a project/implementation plan based on deal context.

### Project Plan Template

```markdown
# Project Plan: [Company Name] — [Project Title]

**Generated:** [Date]
**Deal Type:** [New Business / Expansion / Renewal / RFP / Partnership]
**Status:** Draft — Pending Deal Close
...
### Objective
[What this project will achieve for the prospect, in their language]

### Scope Summary
[High-level scope: what's included and what's not]
...
|-----------|-------------|-------|
| [Component 1] | [What it does] | [Our team / Their team / Joint] |

### Integration Points
| System | Integration Type | Complexity |
|--------|-----------------|------------|
| [System] | [API / File / Manual] | [Low/Medium/High] |

---

## Implementation Phases

### Phase 1: Discovery & Planning ([Duration])
**Objective:** Validate requirements and finalize implementation approach

| Deliverable | Description | Owner |
|-------------|-------------|-------|
| Requirements document | Detailed functional and technical requirements | Joint |
| Architecture design | Solution design and integration mapping | Our team |
| Project schedule | Detailed timeline with dependencies | PM |

### Phase 2: Build & Configure ([Duration])
**Objective:** Implement the core solution
...
### Phase 3: Testing & Validation ([Duration])
**Objective:** Verify solution meets requirements

| Activity | Description | Participants |
|----------|-------------|--------------|
| Unit testing | Component-level testing | Development team |
| Integration testing | End-to-end flow validation | Joint team |
| UAT | User acceptance testing | Client team |

### Phase 4: Deployment & Go-Live ([Duration])
**Objective:** Production deployment and handover

| Activity | Description | Owner |
|----------|-------------|-------|
| Production deployment | Deploy to production environment | Our team |
| Data migration | Migrate data if applicable | Joint |
| Training | End-user training sessions | Our team |
| Go-live support | Hypercare period | Our team |

### Phase 5: Stabilization & Handover ([Duration])
**Objective:** Ensure stability and transition to BAU

| Activity | Description | Duration |
|----------|-------------|----------|
| Hypercare | Dedicated support period | [X] weeks |
| Knowledge transfer | Documentation and training | [X] weeks |
| Transition to support | Move to standard support model | [Date] |
...
|------|-----------|----------|
| Project Manager | [X]% | All phases |
| Solution Architect | [X]% | Phase 1-2 |
| Developer(s) | [X]% | Phase 2-3 |

### Client Team
| Role | Allocation | Phase(s) |
|------|-----------|----------|
| Project Sponsor | As needed | All phases |
| Business SME | [X]% | Phase 1, 3 |
| IT Lead | [X]% | Phase 2-4 |
...
### Dependencies
- [Dependency 1: e.g., "Client provides API access by Phase 2"]
- [Dependency 2]

### Assumptions
- [Assumption 1: e.g., "Existing infrastructure supports the solution"]
- [Assumption 2]
...
|-------|-------|-----|----------|
| Discovery & Planning | [Date] | [Date] | [X] weeks |
| Build & Configure | [Date] | [Date] | [X] weeks |
| Testing & Validation | [Date] | [Date] | [X] weeks |
| Deployment & Go-Live | [Date] | [Date] | [X] weeks |
| Stabilization | [Date] | [Date] | [X] weeks |
| **Total** | | | **[X] weeks** |
```

### Adapting by Deal Type

| Deal Type | Project Plan Emphasis |
|-----------|----------------------|
| **New Business** | Full implementation plan with all phases |
| **Expansion** | Focus on incremental scope, reference existing architecture |
| **Renewal** | Focus on optimization, new features, migration if needed |
| **RFP Response** | Map deliverables to RFP requirements, compliance matrix |
| **Partnership** | Joint responsibilities, integration architecture, co-development |

---

## Phase 4: Confluence Publishing

### Step 4.1: Check for Existing Pages

Use the Atlassian MCP server to search Confluence:

```
Search: "Deals [Company Name]" in Confluence
- If space/page exists → update existing pages
- If not found → create new page hierarchy
```

### Step 4.2: Page Hierarchy

Create this structure in Confluence:

```
[Space: Deals] (or user-specified space)
  └── [Company Name]              ← Parent page
       ├── Sales Plan              ← Sales plan content
       ├── Project Plan            ← Project plan content
       └── Email Context           ← Summary of email research (optional)
```

### Step 4.3: Publish Pages

For each page:
1. Convert markdown content to Confluence-compatible format
2. Create the page using the Atlassian MCP `create_page` tool
3. Add labels: `deal`, `[company-name]`, `[deal-type]`, `sales-plan` or `project-plan`
4. Report back the page URLs to the user

### Step 4.4: Handle Updates

If pages already exist from a previous run:
- Search for existing pages by title under the company parent page
- Update the content rather than creating duplicates
- Add a "Last Updated" note at the top of each page

See `references/confluence-publishing.md` for detailed Atlassian MCP patterns.
...
Save all generated content to the artifacts directory:

```
artifacts/{task_id}/
  ├── deal-context.md        ← Email analysis summary
  ├── sales-plan.md          ← Complete sales plan
  ├── project-plan.md        ← Complete project plan
  └── confluence-links.md    ← URLs to published Confluence pages
```
...
```markdown
## Deal Workspace: [Company Name]

**Deal Type:** [Type]
**Emails Analyzed:** [X] threads
**Confluence:** [Published / Not connected]

### What I Created

1. **Sales Plan** — MEDDPICC qualification, stakeholder map, deal strategy, action plan
   - Local: `artifacts/{task_id}/sales-plan.md`
   - Confluence: [URL if published]

2. **Project Plan** — Implementation scope, milestones, deliverables, timeline
   - Local: `artifacts/{task_id}/project-plan.md`
   - Confluence: [URL if published]

3. **Deal Context** — Email analysis with extracted requirements, contacts, timeline
   - Local: `artifacts/{task_id}/deal-context.md`

### Key Findings from Emails
- [Top 3 findings from email analysis]
...
### Want to iterate?
- "Update the sales plan with [new info]"
- "Add a section on [topic] to the project plan"
- "Re-publish to Confluence"
- "Pull more emails about [topic]"
```
...
### Content
- [ ] Company name correct throughout both plans
- [ ] Contact names match email context
- [ ] Pain points traced back to email evidence
- [ ] Timeline aligns with dates from emails
- [ ] No placeholder text remaining
- [ ] Deal type accurately reflected in both plans

### Confluence (if publishing)
- [ ] Pages created under correct parent
- [ ] Formatting renders correctly
- [ ] Labels applied
- [ ] Links work

### Reusability
- [ ] Templates use contextual placeholders, not hardcoded values
- [ ] Deal type properly detected and plan sections adjusted
- [ ] Works without Confluence (local artifacts saved)
- [ ] Works without Gmail (user can provide context manually)
...
## Command: deal-workspace
---
description: Set up a full deal workspace — pull emails, build sales & project plans, publish to Confluence
...
Set up a complete deal workspace for any prospect. Gathers email context, researches the account, generates a sales plan and project plan, and publishes everything to Confluence.

## Usage

```
/deal-workspace
/deal-workspace GroceryMart
/deal-workspace "Acme Corp"
```
...
├─────────────────────────────────────────────────────────────────┤
│  STANDALONE (always works)                                       │
│  ✓ Search Gmail for deal-related emails                         │
│  ✓ Research the prospect (web search)                           │
│  ✓ Generate sales plan (MEDDPICC framework)                     │
│  ✓ Generate project plan (scope, milestones, timeline)          │
│  ✓ Save all artifacts locally                                   │
├─────────────────────────────────────────────────────────────────┤
│  SUPERCHARGED (when you connect your tools)                      │
│  + ~~email~~: Search and read prospect emails automatically     │
│  + ~~knowledge base~~: Publish plans to Confluence              │
│  + ~~CRM~~: Pull deal history, contacts, prior opportunities    │
│  + ~~enrichment~~: Verified contacts, tech stack, org chart     │
└─────────────────────────────────────────────────────────────────┘
```
...
**Optional (I'll ask if needed):**
- Deal type (New Business, Expansion, Renewal, RFP Response, Partnership)
- Email search keywords (specific subjects or contact names)
- Confluence space to publish to
- Additional context about the deal

**Option A: Minimal input**
```
/deal-workspace GroceryMart
```
I'll search your emails, research the company, and build both plans.

**Option B: With context**
```
/deal-workspace GroceryMart
This is a new business deal for grocery store digitization.
Key contact is John Smith. Check emails from last 2 weeks.
Publish to the SALES space in Confluence.
```

**Option C: Describe the deal**
```
/deal-workspace
I'm working on a proposal for a grocery chain that wants to
digitize their operations. I've been emailing with their CTO
about it. Build me the full workspace.
```
...
1. **Deal Context** — Summary of email analysis
   - Key contacts and their roles
   - Requirements extracted from emails
   - Timeline and budget signals
   - Open questions

2. **Sales Plan** — Full deal strategy
...
3. **Project Plan** — Implementation roadmap
...
4. **Confluence Pages** (if connected)
   - Structured pages under `Deals / [Company Name] /`
   - Sales Plan page
   - Project Plan page

### Local Artifacts

All content is saved to `artifacts/{task_id}/`:
```
artifacts/{task_id}/
  ├── deal-context.md
  ├── sales-plan.md
  ├── project-plan.md
  └── confluence-links.md    (if published)
```
...
```
/deal-workspace [Company]
        │
        ▼
┌──────────────────┐
│ 1. Email Scan    │  Search Gmail for [Company] emails
│    (~~email~~)   │  Extract context, contacts, requirements
└────────┬─────────┘
         ▼
┌──────────────────┐
│ 2. Research      │  Web search: company, industry, leadership
│    (web search)  │  Build account profile
└────────┬─────────┘
         ▼
┌──────────────────┐
│ 3. Sales Plan    │  MEDDPICC, stakeholders, strategy, actions
│    (generate)    │  Save to artifacts/
└────────┬─────────┘
         ▼
┌──────────────────┐
│ 4. Project Plan  │  Scope, phases, milestones, resources
│    (generate)    │  Save to artifacts/
└────────┬─────────┘
         ▼
┌──────────────────┐
│ 5. Publish       │  Create/update Confluence pages
│ (~~knowledge     │  Report URLs back to user
│    base~~)       │
└──────────────────┘
```
...
The workspace adapts based on deal type:

| Type | Sales Plan Focus | Project Plan Focus |
|------|------------------|--------------------|
| **New Business** | Full MEDDPICC, competitor analysis | Complete implementation roadmap |
| **Expansion** | Upsell positioning, existing relationship | Incremental scope, existing architecture |
| **Renewal** | Value realized, optimization opportunities | Upgrade path, new features |
| **RFP Response** | Requirements mapping, compliance matrix | Deliverables mapped to RFP sections |
| **Partnership** | Joint value proposition, co-sell model | Joint development, integration plan |
...
- **Update plans:** "Update the sales plan for GroceryMart with [new info]"
- **Re-publish:** "Re-publish the project plan to Confluence"
- **Pull more emails:** "Check for new emails about GroceryMart"
- **Add sections:** "Add a competitive analysis to the sales plan"
- **Create assets:** Use `/create-an-asset GroceryMart` to build customer-facing materials based on the deal context

---

## Tips

1. **More email context = better plans** — The more deal-related emails you have, the richer the output
2. **Specify deal type** — Helps tailor both plans to the right focus areas
3. **Re-run after new info** — Got new emails or meeting notes? Re-run to update the workspace
4. **Confluence is optional** — Everything works without it; plans save locally either way
5. **Combine with other skills** — Use `account-research` for deeper prospect intel, `call-prep` for meeting prep, `create-an-asset` for customer-facing materials
